...
# with open('./reformatedNDDs/dataset_experiment_video_11012024.pkl', 'rb') as f:
# with open('./reformatedNDDs/dataset_experiment_video_11052024.pkl', 'rb') as f:
# with open('./reformatedNDDs/dataset_experiment_video_11072024.pkl', 'rb') as f:
# with open('./reformatedNDDs/dataset_experiment_video_11072024_notBlackWhite.pkl', 'rb') as f:
# with open('./reformatedNDDs/dataset_experiment_video_11082024.pkl', 'rb') as f:
# with open('./reformatedNDDs/dataset_experiment_video_11112024_bl.pkl', 'rb') as f:
# with open('./reformatedNDDs/dataset_experiment_full_time_resol_11122024.pkl', 'rb') as f:
# with open('./reformatedNDDs/dataset_experiment_full_time_resol_longPred_20_40_11162024.pkl', 'rb') as f:
...
# from openstl.methods import method_maps  # Assuming SimVP is included in method_maps
# from openstl.utils import create_parser, default_parser
# # from openstl.datasets import MovingMNIST  # Replace with your dataset if needed
...
# # train_set = MovingMNIST(root='data/', is_train=True, n_frames_input=10, n_frames_output=10)
# # val_set = MovingMNIST(root='data/', is_train=False, n_frames_input=10, n_frames_output=10)

# # dataloader_train = DataLoader(train_set, batch_size=custom_training_config['batch_size'], shuffle=True)
# # dataloader_val = DataLoader(val_set, batch_size=custom_training_config['val_batch_size'], shuffle=False)

# # Model
# in_shape = custom_training_config['in_shape']
# model_config = {
#     'N_S': custom_model_config['N_S'],
#     'N_T': custom_model_config['N_T'],
#     'hid_S': custom_model_config['hid_S'],
#     'hid_T': custom_model_config['hid_T'],
#     'model_type': custom_model_config['model_type'],
# }

# device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
# model = method_maps[custom_model_config['method']](in_shape=in_shape, **model_config).to(device)

# # Loss and Optimizer
# criterion = nn.MSELoss()
# optimizer = optim.Adam(model.parameters(), lr=custom_training_config['lr'])

# # Training Loop
# num_epochs = custom_training_config['epoch']
...
#     # Logging
#     print(f"Epoch [{epoch + 1}/{num_epochs}], Train Loss: {train_loss / len(dataloader_train):.4f}, "
#           f"Val Loss: {val_loss / len(dataloader_val):.4f}")

# # Save Model
# torch.save(model.state_dict(), f"{custom_training_config['ex_name']}_model.pth")
